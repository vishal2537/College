...
abstract class user {
    final String s = "IIITG MEMBER"; // final member
...
final class student extends user {
    ...
    final public void setDetails(String name, int birthyear, int userid, int rollnumber, int semester, Float cpi,
            String dateOfBirth) {
    ...
    final public void getDetails(int birthyear) {
        if (this.birthYear == birthyear) {
    ...
    final public void getDetail(int userId, int rollno, int birthYear) {
    ...
    final public int getRollNumber() {
        return rollNumber;
    }
...
final class faculty extends user {
    ...
    final public void setdetails(String name, int birthyear, int userid, int employeeid, String departmentname,
    ...
    final public void checkDepartmentNamee(faculty f1, faculty f2) {
    ...
    final boolean checkEmployeeId(faculty f1, faculty f2) {
    ...
    final public void getDetail(int userid, int employeeID, int birthYear) {
    ...
    final public int getEmployeeID() {
        return employeeID;
    }
}
...
final class staff extends user {
    ...
    final public void setdetails(String name, int birthyear, int userid, int employeeid, String setion,
            String designation,
            String dateOfBirth) {
        super.setDetails(name, birthyear, userid, dateOfBirth);
        this.employeeID = employeeid;
    ...
    final public void getDetail(int birthYear) {
        if (this.birthYear == birthYear) {
            super.getDetails(birthYear);
            System.out.println("\t\tEMPLOYEEID : " + employeeID);
    ...
    final public void getDetails(int userId, int employeeID, int birthYear) {
        if (this.userId == userId && this.employeeID == employeeID && this.birthYear == birthYear) {
            super.getDetails(birthYear);
            System.out.println("\t\tEMPLOYEEID : " + employeeID);
            System.out.println("\t\tSECTIONNAME : " + sectionName);
...
public class assignment_7 {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // System.out.println("\t5 - FOR CREATING ABSTRACT CLASS ");
